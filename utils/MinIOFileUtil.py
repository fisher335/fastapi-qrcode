...
class Bucket(object):
    ...
    def __init__(self):
        self.client = Minio(self.service, access_key=self.access_key, secret_key=self.secret_key, secure=False)
    ...
    def presigned_get_file(self, bucket_name, file, hours=1):
        """
        生成一个http GET操作 签证URL
        :return:
        """
        return self.client.presigned_get_object(bucket_name, file, expires=timedelta(hours= hours))
